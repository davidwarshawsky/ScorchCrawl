...
// Normalize empty-string URL env vars to undefined so downstream
// providers don't receive an empty baseURL (which can produce
// invalid relative-request errors like "Invalid URL").
if (config.OPENAI_BASE_URL === "") {
  // eslint-disable-next-line @typescript-eslint/ban-ts-comment
  // @ts-ignore - allow assignment to optional env prop for runtime normalization
